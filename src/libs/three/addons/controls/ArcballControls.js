  ...
  applyTransformMatrix(transformation) {
    ...
    if (
      ...
      if (this.adjustNearFar) {
        const cameraDistance = this.object.position.distanceTo(
          this._gizmos.position
        );
  ...
  pan(p0, p1, adjust = false) {
    ...
    if (this.object.isOrthographicCamera) {
      ...
      const distanceFactor =
        ...
        this.object.position.distanceTo(this._gizmos.position);
  ...
  update() {
    ...
    if (this.object.isOrthographicCamera) {
      ...
      if (this.object.zoom > this.maxZoom || this.object.zoom < this.minZoom) {
        ...
        this.applyTransformMatrix(
          this.scale(newZoom / this.object.zoom, this._gizmos.position, true)
        );
      }
    } else if (this.object.isPerspectiveCamera) {
      //check distance
      ...
      if (this.object.fov < this.minFov || this.object.fov > this.maxFov) {
        this.object.fov = MathUtils.clamp(
          this.object.fov,
          this.minFov,
          this.maxFov
        );
